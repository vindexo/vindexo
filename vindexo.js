    ...
    !function (a, b) {
        ...
        function hb(a, b, c) {
            var d, e, f = 0, g = hb.prefilters.length, h = r.Deferred().always(function () {
                ...
                if (e)return !1;
                for (var b = Za || cb(), c = Math.max(0, j.startTime + j.duration - b), d = c / j.duration || 0,
...
$(document).ready(function () {
    ...
    iframes.each(function (index, value) {
        ...
        if (values != null && values[1]) {
            var jqxhr = $.get(hostname + "/video/check", {original_id: values[1]}, function (video_id) {
                if (video_id > 0) {// Video ID varsa
                    new_url = hostname + "/video/embed/1/" + video_id + "/" + seek_id;
